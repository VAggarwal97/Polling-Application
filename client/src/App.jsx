        ...
        <div className="App">
          ...
          <div className="tbd">
            <div className="tbd-container">
              ...
              <i className="fas fa-arrow-circle-right"></i> Share it with
              friends
            </div>
          </div>
          ...
          <div className="main">
            ...
            <Route
              path="/new"
              render={(props) => <NewPoll authData={this.state} {...props} />}
            />
            <Route
              path="/my"
              render={(props) => <MyPolls authData={this.state} {...props} />}
            />
            <Route
              path="/poll/:input"
              render={(props) => <Poll authData={this.state} {...props} />}
            />
