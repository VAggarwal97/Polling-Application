...
const NavBar = ({ onFacebookLogin, isAuth, username }) => {
  return (
    <nav>
      <Link to="/">
        <div className="logo">votemenow</div>
      </Link>
      <div className="right-side">
        ...
        <ul className="nav-ul">
          ...
          <Link to="/my">
            <li className="nav-li">My Polls</li>
          </Link>
          <Link to="/about">
...
const MobileNavBar = () => {
  return (
    <div className="mobile-navbar" id="mobile-navbar">
      <Link className="mobile-nav-button" to="/">
        <i className="far fa-edit"></i>
      </Link>
      <Link className="mobile-nav-button" to="/explore">
        <i className="fas fa-fire"></i>
      </Link>
      <Link className="mobile-nav-button" to="/my">
        <i className="far fa-user"></i>
      </Link>
      <Link className="mobile-nav-button" to="/about">
